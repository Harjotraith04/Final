...
function VisualizationDashboard({ data }) {
  ...
  const renderChart = (chartId, title, description, children) => (
    <Paper 
      sx={{ 
        p: 1.5, // Reduced padding for more space
  ...
  return (
    <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      <Box sx={{ flexGrow: 1, p: 1, overflow: 'auto' }}> {/* Reduced padding for more space */}
        <TabPanel value={activeTab} index={0}>
          <Grid container spacing={1}> {/* Reduced spacing for more space */}
            {/* Overview Section */}
            <Grid item xs={12}>
