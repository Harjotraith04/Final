...
def finalize_code_assignments(
    assignment_ids: List[int],
    db: Session = Depends(get_db),
    current_user: User = Depends(get_current_user)
):
    """Submit code assignments and return compiled finalized codes"""
    try:
        # Submit the code assignments
        result = CodeAssignmentService.submit_assignments(
            db=db,
